...
namespace WindowsFormsApp6
{
    public partial class seerequests : Form
    {
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sqlselectquery2 = "Select name_paper from paper where accept ='" + textBox6.Text + "' ";
        ...
        private void checkBox9_CheckedChanged(object sender, EventArgs e)
        {
            ...
            con2.Open();
            string sqlselectquery = "Select author_n,publisher_name,category_paper,article from paper where name_paper ='" + comboBox1.Text + "'";
            ...
            while (da1.Read())
            {
                ...
                textBox5.Text = (da1["category_paper"].ToString());
                textBox2.Text = (da1["article"].ToString());
                textBox3.Text = (da1["publisher_name"].ToString());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-IRDCSG7;Initial Catalog=Project;Integrated Security=True");
            con.Open();
            string update_query = @"update paper Set accept='" + textBox4.Text + "' where name_paper='" + comboBox1.Text + "'";
            SqlCommand comm = new SqlCommand(update_query, con);
            comm.ExecuteNonQuery();
            con.Close();
            MessageBox.Show("Thank You ,Data Added Sucessfully");
            Hide();
            Form1 f = new Form1();
            f.Show();
        }
